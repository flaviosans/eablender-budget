 ...
 */
 ...
 add_shortcode( 'wp-ea-bridge', 'wpEaBridge' );
...
<script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js\"
  ...
  <link rel=\"stylesheet\" href=\"" . $plugin_path . "css/step.css\">
  <div id=\"thanks\" style=\"display: none\">
     <img class=\"img-fluid mx-auto d-block w3-animate-fading\" src=\"" . $plugin_path . "img/resized/checked.png\" alt=\"check-form\"> <br>
     <h5>Obrigado!</h5>
 ...
 <div class=\"step-tab\">
   <div class=\"form-group\">
     ...
     <input onkeyup=\"findCep()\" type=\"text\" class=\"form-control\" maxlength=\"8\" id=\"budgetZipCode\" required
       minlength=\"9\" />
     <span id=\"cep-error\" class=\"text-danger m-t-5\">Digite seu cep acima:</span>
     <div class=\"form-group\">
   ...
   <div class=\"container\">
      ...
      <div class=\"row col-md-12 col-sm-12 col-12 w-auto\">
           <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(1)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "/img/resized/construction.png\">
               </figure>Construção
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(2)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/reform_new.png\">
               </figure>Reforma
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(3)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/design.png\"></figure>
               Decoração
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(4)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/landscaping.png\">
       ...
       <div class=\"row col-md-12 col-sm-12 col-12 w-auto\">
           ...
           <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(5)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/lot.png\"></figure>
               Loteamento
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(6)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\"
                   src=\"" . $plugin_path . "img/resized/general_projects.png\"></figure>Projetos em geral
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(7)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\"
                   src=\"" . $plugin_path . "img/resized/facilities_and_services.png\"></figure>Instalações e serviços
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(8)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/paving.png\"></figure>
               Pavimentação
             </div>
       ...
       <div class=\"row col-md-12 col-sm-12 col-12 w-auto\">
           ...
           <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(9)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/changes.png\">
               </figure>Mudanças
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(10)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\"
                   src=\"" . $plugin_path . "img/resized/repairs_and_services.png\"></figure>Reparos e serviços
             </div>
             <div class=\"col-md-3 col-sm-6 col-6 imgBudget hover01\" onclick=\"addCategory(11)\">
               <figure><img class=\"img-responsive\" style=\"background-color: #0579ff\" src=\"" . $plugin_path . "img/resized/other.png\"></figure>
               Outros
             </div>
     ...
     <div class=\"col-6 bc__separete-vertical\">
       <label><strong>Contato</strong></label>
         ...
         <div class=\"form-group\">
           ...
           <input onblur=\"setPhone(this.value)\" type=\"tel\" class=\"form-control\" id=\"phoneBudget\" name=\"phoneBudget\"
                 ...
                 <div class=\"radio form-radio form-row form-check form-check-inline\">
                   <label class=\"form-check-label\" style=\"padding-left: 0.5em; padding-right: 1.6em;\">
                     <input type=\"radio\" onclick=\"setEstimatedPrice(this.value)\" class=\"form-check-input hide\"
                       id=\"optradio1\" name=\"optradio\" value=\"1\" checked>
...
<script src=\"" . $plugin_path . "/js/step.js\"></script>";
 }